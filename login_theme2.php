...
<body>
    ...
    <link rel="stylesheet" href="pages/login_theme2/style_L_theme2.css">
    ...
    <div class="body">
        <!-- <a id="back" href="http://localhost/DevBugs/landing_theme2.php">Back</a> -->
        <div class="container">
            <label class="login">Log In</label>
            <div class="login-container">
                <form action="pages/home_theme2/home_theme2.php" method="POST" id="login_form">
                    <div class="entryarea">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="registration_form" method="POST" action="actions/insert_T2.php">
...
<script>
    ...
    <script>
        function to_home_T2() {
            $.post("home_theme2.php", {}, function (data) {
                $("#contents").html(data);  
            });
        }
    </script>
    <script>
        function to_forgotpassword_t2() {
            window.location.href = '/DevBugs/forgot_password_theme2.php';
        }
    </script>
</body>
</html>
