...
<body>
    ...
    <link rel="stylesheet" href="pages/home_theme3/style_h_theme3.css">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="m-2">
                    ...
                    <button class="btn btn-dark" type="button" id="aboutUsLink" onclick="to_aboutUs_t3()" href="aboutus__theme3.php">
                        About Us
                    </button>
                    <button class="btn btn-dark" type="button" id="contactUsLink" onclick="to_contactUs_t3()" href="contactus__theme3.php">
                        Contact Us
                    </button>
            ...
            <button type="button" class="btn btn-secondary" id="openCustomerMessagesModalBtn" data-bs-toggle="modal" data-bs-target="#modal_customess"
                style="position: absolute; margin-left: 990px; margin-top: 0px; transform: scaleX(1.0);"
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="card-body text-center">
                                            <img src="pages/home_theme3/ICON_DASHBOARD.png" style="width: 1.6in; height: 1.6in; margin-left: -30px; margin-top: 15px;" id="db_icon" alt="..."
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="card-body text-center">
                                            <img src="pages/home_theme3/ICON_BELL.png" style="width: 1.8in; height: 1.8in; margin-left: -20px;" id="alnot_icon" alt="...">
                                        </div>
                                    <!-- </div> -->
                                    <div class="card-body text-center">
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <div class="col-6">
                                    <!-- <div class="card border-0" id="vm" style="margin-left: -10px; margin-right: 10px;"> -->
                                        <div class="card-body text-center">
                                            <img src="pages/home_theme3/ICON_VOICEFEEDBACK.png" style="width: 1.8in; height: 1.8in; margin-left: -5px;" id="vm_icon" alt="...">
                                        </div>
                                    <!-- </div> -->
                                    <div class="card-body text-center">
                                ...
                                <div class="col-6">
                                    <!-- <div class="card border-0" id="t" style="margin-left: -10px; margin-right: 10px;"> -->
                                        <div class="card-body text-center">
                                            <img src="pages/home_theme3/ICON_THEMES.png" style="width: 1.8in; height: 1.8in; margin-left: -20px;" id="t_icon" alt="..."
                                    ...
                                    <div class="card border-0" id="card1">
                                        <div class="card-body" style="text-align: left;">
                                            <div class="card-body">
                                                ...
                                                <h6 class="card-subtitle mb-2 text-muted" style="font-size: 25px; position: absolute; margin-top: 70px;">New Feedbacks</h6>
                                ...
                                <div class="col-3 d-flex justify-content-center">
                                    ...
                                    <div class="card border-0" id="card2">
                                        <div class="card-body" style="text-align: left;">
                                            <div class="card-body">
                                                <h1 class="card-title"style="font-size: 90px; position: absolute; margin-top: -25px;"><?php echo $feedbackCount; ?></h1>
                                                <h6 class="card-subtitle mb-2 text-muted" style="font-size: 25px; position: absolute; margin-top: 70px;">Total Feedbacks</h6>
                                    ...
                                    <div class="card border-0" id="card3">
                                        <div class="card-body" style="text-align: left;">
                                            <div class="card-body">
                                                ...
                                                <h6 class="card-subtitle mb-2 text-muted" style="font-size: 25px; position: absolute; margin-top: 70px;">Feedbacks a day</h6>
                                    ...
                                    <div class="card border-0" id="card4">
                                        <div class="card-body" style="text-align: left;">
                                            <div class="card-body">
                                                ...
                                                <h6 class="card-subtitle mb-2 text-muted" style="font-size: 25px; position: absolute; margin-top: 70px;">Customers</h6>
                                    ...
                                    <div class="card border-0" id="card5">
                                        <div class="card-body" style="text-align: left;">
                                            <div class="card-body">
                                                ...
                                                <h6 class="card-subtitle mb-2 text-muted" style="font-size: 25px; position: absolute; margin-top: 70px;">5-Rating</h6>
