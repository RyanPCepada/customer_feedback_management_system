...
<body>
    ...
    <link rel="stylesheet" href="pages/login_theme3/style_L_theme3.css">
    ...
    <div class="body">
        <!-- <a id="back" href="http://localhost/DevBugs/landing_theme3.php">Back</a> -->
        <div class="container">
            <label class="login">Log In</label>
            <div class="login-container">
                <form action="pages/home_theme3/home_theme3.php" method="POST" id="login_form">
                    <div class="entryarea">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="registration_form" method="POST" action="actions/insert_T3.php">
...
<script>
    ...
    <script>
        function to_home_t3() {
            $.post("home_theme3.php", {}, function (data) {
                $("#contents").html(data);  
            });
        }
    </script>
    <script>
        function to_forgotpassword_t3() {
            window.location.href = '/DevBugs/forgot_password_theme3.php';
        }
    </script>
</body>
</html>
