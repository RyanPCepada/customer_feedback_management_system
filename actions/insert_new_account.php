...
if ($pword == $confirmpword) {
    ...
    try {
        ...
        //tbl_customer_info
        $insertNewAccount = $conn->prepare('INSERT INTO tbl_customer_info (firstName, lastName, email, password, image, userAccess_ID) 
        VALUES (?, ?, ?, ?, ?, ?)');
        $insertNewAccount->execute([$fname, $lname, $email, $pword, "25_2023.11.14_03.40.18am", $accesstypeID]); // Assumes auto-generated ID
        ...
        echo 'window.location.href = "http://localhost/DevBugs/login_main.php";</script>';
