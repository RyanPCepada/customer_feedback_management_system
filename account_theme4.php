...
<body>
    ...
    <link rel="stylesheet" href="pages/account_theme4/style_acc_theme4.css">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="m-2">
                    <button class="btn btn-dark" type="button" id="homeLink" onclick="to_home_t4()" href="home_theme4.php" style="margin-left: -32px;">
                        Home
                    </button>
                    <button class="btn btn-dark" type="button" id="aboutUsLink" onclick="to_aboutUs_t4()" href="aboutus_theme4.php">
                        About Us
                    </button>
                    <button class="btn btn-dark" type="button" id="contactUsLink" onclick="to_contactUs_t4()" href="contactus_theme4.php">
                        Contact Us
                    </button>
            ...
            <img src="images/<?php echo $image; ?>" class="" onclick="to_account_t4()" style="width: 25px; height: 25px; border-radius: 12.5px;">

            <div class="m-2 text-light">
                <b class="bg-transparent" id="accountLink" onclick="to_account_t4()" style="cursor: pointer;"> <img src="navigation/user.png" alt="">Account</b>
            </div>
        </div>
    </nav>
            ...
            <div class="row">
                <div class="col-2 bg-transparent">
                    ...
                    <div class="col-2 text-danger">
                        ...
                        <form action="actions/logoutAction_T4.php" method="post">
                            <style>
                                .blue-button {
                            ...
                            <button class="btn btn-dark" type="submit" id="logout" onclick="window.location.href='login_theme4.php'"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <img src="pages/account_theme4/GIF_PROFILE.gif" style="width: 1.4in; height: .8in; margin-left: 0px;" id="profile_gif">
                    <!-- <img  src="pages/account/profpic.png"> -->
                </div>

                <div class="modal-body">

                    <form id="editprofile_form" method="POST" action="actions/edit_profile_T4.php">
    ...
    <div class="modal fade" id="changeProfilePicModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form" id="form" action="actions/update_profile_T4.php" enctype="multipart/form-data" method="post">
                        <div class="upload">
                            <?php
                                $sql = "SELECT image FROM tbl_customer_info WHERE customer_ID = :customerID";
                                $stmt = $conn->prepare($sql);
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <img src="pages/account_theme4/GIF_BGINFO.gif" style="width: 1.5in; height: 1in; margin-right: -15px;" id="bginfo_gif">
                    <!-- <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> -->
                </div>
                <div class="modal-body">

                    <form id="background_information_form" method="POST" action="actions/change_bgT4.php">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <img src="pages/account_theme4/GIF_SETTINGS.gif" style="width: 1.5in; height: 1in; margin-left: 0px;" id="settings_gif">
                    <!-- <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> -->
                </div>
                <div class="modal-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <img src="pages/account_theme4/GIF_PASSWORD.gif" style="width: 1.6in; height: .9in; margin-right: -15px;" id="password_gif">
                </div>
                <div class="modal-body">
                    <form id="change_password_form" method="POST" action="actions/change_passT4.php">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <img src="pages/account_theme4/GIF_HISTORY.gif" style="width: 1.75in; height: 1in; margin-left: 195px;" id="bginfo_gif">
                <div>
                </div class="row">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <img src="pages/account_theme4/GIF_THEMES.gif" style="width: 1.6in; height: .9in; margin-right: -15px;" id="password_gif">
                </div>
                <div class="modal-body">
                    <!-- <form id="feedback_history_form" method="POST" action="actions/change_password.php"> -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <img src="pages/account_theme4/GIF_TERMSPRIVACY.gif" style="width: 1.6in; height: .9in; margin-right: -15px;" id="password_gif">
                </div>
                <div class="modal-body">
...
<script>
    function to_login_t4() {
$.post("login_theme4.php", {},function (data) {
      $("#contents").html(data);  
    });
}   
</script>
