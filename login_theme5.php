...
<body>
    ...
    <link rel="stylesheet" href="pages/login_theme5/style_L_theme5.css">
    ...
    <div class="body">
        <!-- <a id="back" href="http://localhost/DevBugs/landing_theme5.php">Back</a> -->
        <div class="container">
            <label class="login">Log In</label>
            <div class="login-container">
                <form action="pages/home_theme5/home_theme5.php" method="POST" id="login_form">
                    <div class="entryarea">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="registration_form" method="POST" action="actions/insert_T5.php">
...
<script>
    ...
    <script>
        function to_home_t5() {
            $.post("home_theme5.php", {}, function (data) {
                $("#contents").html(data);  
            });
        }
    </script>
    <script>
        function to_forgotpassword_t5() {
            window.location.href = '/DevBugs/forgot_password_theme5.php';
        }
    </script>
</body>
</html>
