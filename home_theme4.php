...
<body>
    ...
    <link rel="stylesheet" href="pages/home_theme4/style_h_theme4.css">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="m-2">
                    ...
                    <button class="btn btn-dark" type="button" id="aboutUsLink" onclick="to_aboutUs_t4()" href="aboutus__theme4.php">
                        About Us
                    </button>
                    <button class="btn btn-dark" type="button" id="contactUsLink" onclick="to_contactUs_t4()" href="contactus__theme4.php">
                        Contact Us
                    </button>
            ...
            <img src="images/<?php echo $image; ?>" class="img-fluid zoomable-image rounded-square" onclick="to_account_t4()" style="width: 25px; height: 25px; border-radius: 12.5px;">
                ...
                <form id="feedback_form" method="POST" action="actions/insert_feedback.php">
                    ...
                    <div class="bg-transparent text-center">
                        ...
                        <button type="submit" class="btn btn-primary" id="submit_feeback" data-bs-toggle="modal" data-bs-target="#modal_submit_feedback"
                            style="position: absolute; font-size: 21px; margin-top: 520px; margin-left: 500px; width: 220px; height: 50px; border-radius: 35px;">
                            Submit Feedback
                        </button>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="card-body text-center">
                                            <img src="pages/home_theme4/ICON_DASHBOARD.png" style="width: 1.6in; height: 1.6in; margin-left: -30px; margin-top: 15px;" id="db_icon" alt="..."
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="card-body text-center">
                                            <img src="pages/home_theme4/ICON_BELL.png" style="width: 1.8in; height: 1.8in; margin-left: -20px;" id="alnot_icon" alt="...">
                                        </div>
                                    <!-- </div> -->
                                    <div class="card-body text-center">
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <div class="col-6">
                                    <!-- <div class="card border-0" id="vm" style="margin-left: -10px; margin-right: 10px;"> -->
                                        <div class="card-body text-center">
                                            <img src="pages/home_theme4/ICON_VOICEFEEDBACK.png" style="width: 1.8in; height: 1.8in; margin-left: -5px;" id="vm_icon" alt="...">
                                        </div>
                                    <!-- </div> -->
                                    <div class="card-body text-center">
                                ...
                                <div class="col-6">
                                    <!-- <div class="card border-0" id="t" style="margin-left: -10px; margin-right: 10px;"> -->
                                        <div class="card-body text-center">
                                            <img src="pages/home_theme4/ICON_THEMES.png" style="width: 1.8in; height: 1.8in; margin-left: -20px;" id="t_icon" alt="..."
