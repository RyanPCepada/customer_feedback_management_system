...
<body>
    ...
    <link rel="stylesheet" href="pages/contactUs_theme2/style_cu_theme2.css">   <!--nothing happened on this link-->
    ...
    <div id="cu_body">
        ...
        <div class="row col-5">
            <form id="feedback_form" method="POST" action="actions/insert_messageT2.php">
