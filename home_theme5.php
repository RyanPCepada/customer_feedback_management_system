...
<body>
    ...
    <link rel="stylesheet" href="pages/home_theme5/style_h_theme5.css">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="m-2">
                    ...
                    <button class="btn btn-dark" type="button" id="aboutUsLink" onclick="to_aboutUs_t5()" href="aboutus__theme5.php">
                        About Us
                    </button>
                    <button class="btn btn-dark" type="button" id="contactUsLink" onclick="to_contactUs_t5()" href="contactus__theme5.php">
                        Contact Us
                    </button>
            ...
            <img src="images/<?php echo $image; ?>" class="img-fluid zoomable-image rounded-square" onclick="to_account_t5()" style="width: 25px; height: 25px; border-radius: 12.5px;">
                ...
                <form id="feedback_form" method="POST" action="actions/insert_feedback.php">
                    ...
                    <div class="bg-transparent text-center">
                        ...
                        <button type="submit" class="btn btn-primary" id="submit_feeback" data-bs-toggle="modal" data-bs-target="#modal_submit_feedback"
                            style="position: absolute; font-size: 20px; margin-top: 520px; margin-left: 500px; width: 220px; height: 50px; border-radius: 35px;">
                            <b>Submit Feedback</b>
                        </button>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="header"> <!--DON'T USE MODAL-HEADER, HEADER ONLY-->
                    ...
                    <div class="row">
                        <h style="margin-top: 5px; margin-left: 15px;">Explore our designed key features for a more<br>convenient customer experience.</h>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="card-body text-center">
                                            <img src="pages/home_theme5/ICON_DASHBOARD.png" style="width: 1.6in; height: 1.6in; margin-left: -30px; margin-top: 15px;" id="db_icon" alt="..."
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="card-body text-center">
                                            <img src="pages/home_theme5/ICON_BELL.png" style="width: 1.8in; height: 1.8in; margin-left: -20px;" id="alnot_icon" alt="...">
                                        </div>
                                    <!-- </div> -->
                                    <div class="card-body text-center">
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <div class="col-6">
                                    <!-- <div class="card border-0" id="vm" style="margin-left: -10px; margin-right: 10px;"> -->
                                        <div class="card-body text-center">
                                            <img src="pages/home_theme5/ICON_VOICEFEEDBACK.png" style="width: 1.8in; height: 1.8in; margin-left: -5px;" id="vm_icon" alt="...">
                                        </div>
                                    <!-- </div> -->
                                    <div class="card-body text-center">
                                ...
                                <div class="col-6">
                                    <!-- <div class="card border-0" id="t" style="margin-left: -10px; margin-right: 10px;"> -->
                                        <div class="card-body text-center">
                                            <img src="pages/home_theme5/ICON_THEMES.png" style="width: 1.8in; height: 1.8in; margin-left: -20px;" id="t_icon" alt="..."
                                    ...
                                    <div class="card border-0" id="card1">
                                        <div class="card-body" style="text-align: left;">
                                            <div class="card-body">
                                                ...
                                                <h6 class="card-subtitle mb-2 text-muted" style="font-size: 25px; position: absolute; margin-top: 75px;">New Feedbacks</h6>
                                ...
                                <div class="col-3 d-flex justify-content-center">
                                    ...
                                    <div class="card border-0" id="card2">
                                        <div class="card-body" style="text-align: left;">
                                            <div class="card-body">
                                                <h1 class="card-title"style="font-size: 90px; position: absolute; margin-top: -25px;"><?php echo $feedbackCount; ?></h1>
                                                <h6 class="card-subtitle mb-2 text-muted" style="font-size: 25px; position: absolute; margin-top: 75px;">Total Feedbacks</h6>
                                    ...
                                    <div class="card border-0" id="card3">
                                        <div class="card-body" style="text-align: left;">
                                            <div class="card-body">
                                                ...
                                                <h6 class="card-subtitle mb-2 text-muted" style="font-size: 25px; position: absolute; margin-top: 75px;">Feedbacks a day</h6>
                                    ...
                                    <div class="card border-0" id="card4">
                                        <div class="card-body" style="text-align: left;">
                                            <div class="card-body">
                                                ...
                                                <h6 class="card-subtitle mb-2 text-muted" style="font-size: 25px; position: absolute; margin-top: 75px;">Customers</h6>
                                    ...
                                    <div class="card border-0" id="card5">
                                        <div class="card-body" style="text-align: left;">
                                            <div class="card-body">
                                                ...
                                                <h6 class="card-subtitle mb-2 text-muted" style="font-size: 25px; position: absolute; margin-top: 75px;">5-Rating</h6>
...
<script>
    function to_login_t5() {
$.post("login_theme5.php", {},function (data) {
      $("#contents").html(data);  
    });
}   
</script>
