...
<body>
    ...
    <link rel="stylesheet" href="pages/account_theme2/style_acc_theme2.css">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="m-2">
                    <button class="btn btn-dark" type="button" id="homeLink" onclick="to_home_t2()" href="home_theme2.php" style="margin-left: -20px;">
                        Home
                    </button>
                    <button class="btn btn-dark" type="button" id="aboutUsLink" onclick="to_aboutUs_t2()" href="aboutus_theme2.php">
                        About Us
                    </button>
                    <button class="btn btn-dark" type="button" id="contactUsLink" onclick="to_contactUs_t2()" href="contactus_theme2.php">
                        Contact Us
                    </button>
            ...
            <button type="button" class="btn btn-secondary" id="openCustomerMessagesModalBtn" data-bs-toggle="modal" data-bs-target="#modal_customess"
                style="position: absolute; margin-left: 1003px; margin-top: 0px; transform: scaleX(1.0);"
            ...
            <button type="button" class="btn btn-secondary position-relative" id="openCustomerNotifModalBtn" data-bs-toggle="modal" data-bs-target="#modal_customernotif"
                style="margin-right: 25px; transform: scaleX(1.0);">
                Notifications
            ...
            <img src="images/<?php echo $image; ?>" class="" onclick="to_account_t2()" style="width: 25px; height: 25px; border-radius: 12.5px;">

            <div class="m-2 text-light">
                <b class="bg-transparent" id="accountLink" onclick="to_account_t2()" style="cursor: pointer;"> <img src="navigation/user.png" alt="">Account</b>
            </div>
        </div>
    </nav>
            ...
            <div class="row">
                <div class="col-2 bg-transparent">
                    ...
                    <div class="col-2 text-danger">
                        ...
                        <form action="actions/logoutAction_T2.php" method="post">
                            <style>
                                .blue-button {
                            ...
                            <button class="btn btn-dark" type="submit" id="logout" onclick="window.location.href='login_theme2.php'"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <img src="pages/account_theme2/GIF_PROFILE.gif" style="width: 1.4in; height: .8in; margin-left: 0px;" id="profile_gif">
                    <!-- <img  src="pages/account/profpic.png"> -->
                </div>

                <div class="modal-body">

                    <form id="editprofile_form" method="POST" action="actions/edit_profile_T2.php">
    ...
    <div class="modal fade" id="changeProfilePicModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form" id="form" action="actions/update_profile_T2.php" enctype="multipart/form-data" method="post">
                        <div class="upload">
                            <?php
                                $sql = "SELECT image FROM tbl_customer_info WHERE customer_ID = :customerID";
                                $stmt = $conn->prepare($sql);
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <img src="pages/account_theme2/GIF_BGINFO.gif" style="width: 1.5in; height: 1in; margin-right: -15px;" id="bginfo_gif">
                    <!-- <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> -->
                </div>
                <div class="modal-body">

                    <form id="background_information_form" method="POST" action="actions/change_bgT2.php">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <img src="pages/account_theme2/GIF_SETTINGS.gif" style="width: 1.5in; height: 1in; margin-left: 0px;" id="settings_gif">
                    <!-- <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> -->
                </div>
                <div class="modal-body">
                    ...
                    <form id="registration_form" method="POST"> <!--action="actions/edit_profile.php" -->
                        <div class="input" id="inputfields" style="height: 400px;">
                            ...
                            <button type="button" class="btn btn-secondary" id="sett_closeModalBtn" data-bs-dismiss="modal">Close</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <img src="pages/account_theme2/GIF_PASSWORD.gif" style="width: 1.6in; height: .9in; margin-right: -15px;" id="password_gif">
                </div>
                <div class="modal-body">
                    <form id="change_password_form" method="POST" action="actions/change_passT2.php">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <img src="pages/account_theme2/GIF_HISTORY.gif" style="width: 1.75in; height: 1in; margin-left: 190px;" id="bginfo_gif">
                <div>
                </div class="row">
                <!-- <h style="margin-top: 5px; margin-left: 10px;"><?php echo 'all of <b>' . $firstName . ' ' . $middleName. ' ' . $lastName . '</b>\'s activities<br>'; ?></h> -->
                </div>
                <div class="modal-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <img src="pages/account_theme2/GIF_THEMES.gif" style="width: 1.6in; height: .9in; margin-right: -15px;" id="password_gif">
                </div>
                <div class="modal-body">
                    <!-- <form id="feedback_history_form" method="POST" action="actions/change_password.php"> -->
                    ...
                    <div class="scrollable-content" id="inputfields" style="height: 400px; overflow-y: auto;">
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <div class="col-6">
                                    <div class="card border-0" id="default" style="margin-left: 10px; margin-right: 10px;">
                                        <div class="card-body text-center">
                                            <img src="pages/account_theme2/BG_DEFAULT.png" style="width: 1.63in; height: 1in;" id="img" alt="...">
                                        </div>
                                    </div>
                                    <div class="card-body text-center">
                                ...
                                <div class="col-6">
                                    <div class="card border-0" id="theme1" style="margin-left: 10px; margin-right: 10px;">
                                        <div class="card-body text-center">
                                            <img src="pages/account_theme2/BG_THEME1.png" style="width: 1.63in; height: 1in;" id="img" alt="...">
                                        </div>
                                    </div>
                                    <div class="card-body text-center">
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <div class="col-6">
                                    <div class="card border-0" id="theme2" style="margin-left: 10px; margin-right: 10px;">
                                        <div class="card-body text-center">
                                            <img src="pages/account_theme2/BG_THEME2.png" style="width: 1.63in; height: 1in;" id="img" alt="...">
                                        </div>
                                    </div>
                                    <div class="card-body text-center">
                                ...
                                <div class="col-6">
                                    <div class="card border-0" id="theme3" style="margin-left: 10px; margin-right: 10px;">
                                        <div class="card-body text-center">
                                            <img src="pages/account_theme2/BG_THEME3.png" style="width: 1.63in; height: 1in;" id="img" alt="...">
                                        </div>
                                    </div>
                                    <div class="card-body text-center">
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <div class="col-6">
                                    <div class="card border-0" id="theme4" style="margin-left: 10px; margin-right: 10px;">
                                        <div class="card-body text-center">
                                            <img src="pages/account_theme2/BG_THEME4.png" style="width: 1.63in; height: 1in;" id="img" alt="...">
                                        </div>
                                    </div>
                                    <div class="card-body text-center">
                                ...
                                <div class="col-6">
                                    <div class="card border-0" id="theme5" style="margin-left: 10px; margin-right: 10px;">
                                        <div class="card-body text-center">
                                            <img src="pages/account_theme2/BG_THEME5.png" style="width: 1.63in; height: 1in;" id="img" alt="...">
                                        </div>
                                    </div>
                                    <div class="card-body text-center">
                        ...
                        <script>
                            ...
                            // Add a click event handler for the "Theme4" card
                            ...
                            // Add a click event handler for the "Theme5" card
                    ...
                    <button type="button" class="btn btn-secondary float-end" style="margin-top: 15px;" id="sett_aat_t1_closeModalBtn" data-bs-dismiss="modal">Close</button>
                    <!-- </form> -->
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <img src="pages/account_theme2/GIF_TERMSPRIVACY.gif" style="width: 1.6in; height: .9in; margin-right: -15px;" id="password_gif">
                </div>
                <div class="modal-body">
    ...
    <script>
        $('#saveProfilePic').on('click', function () {
            ...
            if (newProfilePic) {
                // You can upload the new profile picture and update the image source here.
                // For example:
                // const imageUrl = URL.createObjectURL(newProfilePic);
                // document.querySelector('.zoomable-image').src = imageUrl;
            }
     ...
     END SCRIPT FOR CHANGING PROFILE PICTURE -->
...
<script>
    function to_login_t2() {
$.post("login_theme2.php", {},function (data) {
      $("#contents").html(data);  
    });
}   
</script>
